...
declare namespace GoogleAppsScript {
    ...
    export module BigQuery {
        ...
        export interface BigQueryClient {
            ...
            newIterationResult(): IterationResult;
            ...
            // newJobStatistics2ReservationUsage()
            ...
            // newQueryParameterTypeStructTypes()
        ...
        export interface DatasetListDatasets {
            /**
             * The dataset reference. Use this property to access
        ...
        export interface DatasetList {
             ...
             * Each resource contains basic information. For full information about a particular dataset resource,
             * use the Datasets: get method. This property is omitted when there are no datasets in the project.
             */
            datasets?: Array<DatasetListDatasets>;
            /**
        ...
        export interface DatasetReference {
             ...
             * The ID must contain only letters (a-z, A-Z), numbers (0-9), or underscores (_). The
        ...
        export interface ExternalDataConfiguration {
             ...
             * and if there are too many bad records, an invalid error is returned in the job result. The default value
             * is false. The sourceFormat property determines what BigQuery treats as an extra value:
             * CSV: Trailing columns JSON: Named values that don't match any column names Google Cloud Bigtable:
             * This setting is ignored. Google Cloud Datastore backups: This setting is ignored. Avro: This
             * setting is ignored.
             */
             ...
             * The default value is 0, which requires that all records are valid. This setting is ignored for Google Cloud
             * Bigtable, Google Cloud Datastore backups and Avro formats.
             */
            maxBadRecords?: number;
            /**
             * [Optional] The schema for the data. Schema is required for CSV and JSON formats.
             * Schema is disallowed for Google Cloud Bigtable, Cloud Datastore backups, and Avro formats.
             */
            schema?: TableSchema;
            /**
             * [Required] The data format. For CSV files, specify "CSV". For Google sheets, specify "GOOGLE_SHEETS".
             * For newline-delimited JSON, specify "NEWLINE_DELIMITED_JSON". For Avro files, specify "AVRO".
             * For Google Cloud Datastore backups, specify "DATASTORE_BACKUP". [Beta] For Google Cloud
             * Bigtable, specify "BIGTABLE".
             */
            sourceFormat?: string;
            /**
             * [Required] The fully-qualified URIs that point to your data in Google Cloud.
             * For Google Cloud Storage URIs: Each URI can contain one '&#42;' wildcard character and it must come
             * after the 'bucket' name. Size limits related to load jobs apply to external data sources.
             * For Google Cloud Bigtable URIs: Exactly one URI can be specified and it has be a fully specified and
             * valid HTTPS URL for a Google Cloud Bigtable table. For Google Cloud Datastore
        ...
        export interface JobConfiguration {
             ...
             * A valid query will return a mostly empty response with some processing statistics, while an invalid
            ...
            /**
             * [Experimental] The labels associated with this job. You can use these to organize and group your jobs.
             * Label keys and values can be no longer than 63 characters, can only contain lowercase letters,
             * numeric characters, underscores and dashes. International characters are allowed. Label values are
        ...
        export interface JobConfigurationExtract {
             ...
             * The fully-qualified Google Cloud Storage URI where the extracted table should be written.
             */
            destinationUri?: string;
            /**
             * [Pick one] A list of fully-qualified Google Cloud Storage URIs
        ...
        export interface JobConfigurationLoad {
             ...
             * The following values are supported: CREATE_IF_NEEDED: If the table does not
             * exist, BigQuery creates the table. CREATE_NEVER: The table must already exist.
             * If it does not, a 'notFound' error is returned in the job result. The
             ...
             * The separator can be any ISO-8859-1 single-byte character. To use a character in the range 128-255,
             * you must encode the character as UTF8. BigQuery converts the string to ISO-8859-1 encoding,
             ...
             * For example, if you specify "\N", BigQuery interprets "\N" as a null value when loading a CSV file.
             * The default value is the empty string. If you set this property to a custom value,
             * BigQuery throws an error if an empty string is present for all data types except for STRING and BYTE.
             ...
             * Property names are case sensitive and must be top-level properties. If no properties are specified,
             * BigQuery loads all properties. If any named property isn't found in the Cloud Datastore backup,
             * an invalid error is returned in the job result.
             */
            projectionFields?: string[];
            /**
             * [Optional] The value that is used to quote data sections in a CSV file.
             * BigQuery converts the string to ISO-8859-1 encoding, and then uses the first byte of the encoded string
             ...
             * The schema can be omitted if the destination table already exists, or if you're loading data from
        ...
        export interface JobConfigurationQuery {
             ...
             * repeated fields in the query results. allowLargeResults must be true if
             ...
             * this tier will fail (without incurring a charge). If
            ...
            /**
             * Standard SQL only. Set to POSITIONAL to use positional (?) query parameters or to NAMED
             * to use named (@myparam) query parameters in this query.
             */
        ...
        export interface ProjectList {
             ...
             */
            projects?: Array<ProjectListProjects>;
            /**
        ...
        export interface DatasetsCollection {
            /**
             * Deletes the dataset specified by the datasetId value. Before you can remove a dataset,
             * you must remove all its tables, either manually or by specifying
             ...
             */
            get(projectId: string, datasetId: string): Dataset;

            /**
             * Creates a new empty dataset.
             */
            insert(resource: Dataset, projectId: string): Dataset;

            /**
             * Lists all datasets in the specified project to which you have been granted the READER dataset role.
             */
            list(projectId: string): DatasetList;

            /**
             * Updates information in an existing dataset. The update method replaces the entire dataset resource,
             * whereas the patch method only replaces fields that
             * are provided in the submitted dataset resource. This method supports patch semantics.
             */
            patch(resource: Dataset, projectId: string, datasetId: string): Dataset;
             ...
             */
            update(resource: Dataset, projectId: string, datasetId: string): Dataset;
        }
        ...
        export interface JobsCollection {
             ...
             * Job information is available for a six month period after creation. Requires that you're the person who ran
             ...
             * Job information is available for a six month period after creation. The job list is sorted in
             * reverse chronological order, by job creation time.
            ...
            /**
             * Runs a BigQuery SQL query synchronously and returns
             * query results if the query completes within a specified timeout.
             */
            query(resource: QueryResponse, projectId: string): QueryResponse;
        }
        ...
        export interface TabledataCollection {
             ...
             */
            insertAll(resource: TableDataInsertAllRequest, projectId: string, datasetId: string, tableId: string): TableDataInsertAllResponse;
        ...
        export interface TablesCollection {
             ...
             * This method does not return the data in the table, it only returns the table resource, which describes
             * the structure of this table.
             */
            get(projectId: string, datasetId: string, tableId: string): Table;
             ...
             */
            patch(resource: Table, projectId: string, datasetId: string): Table;

            /**
             * Updates information in an existing table. The update method replaces the entire table resource,
             * whereas the patch method only replaces fields that are provided in the submitted table resource.
             */
            update(resource: Table, projectId: string, datasetId: string): Table;
        }
    }
}

declare var BigQuery: GoogleAppsScript.BigQuery.BigQueryClient;